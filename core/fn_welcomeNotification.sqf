...
[] spawn {
	...
	_role1names = ["Welcome to", "prismgaming.co.uk"];
	_role2 = "Chat with us on Teamspeak!";
	_role2names = ["ts3.prismgaming.co.uk"];
	_role3 = "We are number one!";
	_role3names = ["The biggest","Roleplay Community in the UK", "prismgaming.co.uk"];
	_role4 = "Twitter";
	_role4names = ["@prismunitTV"];
	_role5 = "Built from Altis Life";
	_role5names = ["by Tonic and edited by Amnart"];
	_role6 = "Exclusive Skins, Icons and Textures from";
	_role6names = ["Tonic","Amnart","RoleplayUK"];
	_role7 = "Support us";
	_role7names = ["Please support us by donating on prismgaming.co.uk"];
	...
	_role10 = "All thanks";
	_role10names = [format["Special thanks to everyone that helped the server!"]];
